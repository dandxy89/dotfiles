local arr = {
    { "guifont",  "JetBrains Mono" }, { "backup", false }, { "writebackup", false },
    { "swapfile", false }, { "undofile", true }, { "ruler", false }, { "number", true },
    { "relativenumber", true }, { "encoding", "utf8" }, { "fileencoding", "utf8" },
    { "expandtab",      true }, { "shiftwidth", 4 }, { "softtabstop", 4 }, { "tabstop", 4 },
    { "incsearch",  true }, { "splitright", true }, { "splitbelow", true },
    { "autoindent", true }, { "smartindent", true }, { "autowrite", true },
    { "termguicolors", true }, { "ttimeoutlen", 0 }, { "timeoutlen", 300 },
    ...
    { "spelllang", "en_gb" }, { "background", "dark" }, { "compatible", false },
    { "scrolloff", 10 }, { "updatetime", 50 }, { "signcolumn", "yes:1" },
    { "pumheight", 25 }, { "numberwidth", 3 }, { "statuscolumn", "%l%s" },
    { "cmdheight", 1 }, { "laststatus", 0 }, { "winborder", "rounded" },
