...
## Deno
export DENO_INSTALL="/Users/i98012/.deno"
...
# Disable when working with Greg Johnson's Leptos
...
alias loginAWS='saml2aws login -a account'
export AWS_ENVIRONMENT=int
...
## Nvim
alias dd="source .venv/bin/activate; nvim -n -V0"
alias du='echo "Updating nvim via folke/lazy"; nvim --headless "+Lazy! sync" +qa'

## Pyneovim
alias install_pynvim_poetry='poetry run pip install pyvim pynvim ruff-lsp "python-lsp-server[all]" jedi -U'
alias install_pynvim='pip install pyvim pynvim ruff-lsp "python-lsp-server[all]" jedi -U'
...
## To Parquet
alias ParquetToCSV='python3 /Users/i98012/.config/nvim/to_csv.py'
alias RemoveBOM='python3 /Users/i98012/.config/nvim/update_json.py'
